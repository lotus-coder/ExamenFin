...
public class BibliotecaSQLHelper extends SQLiteOpenHelper {
    //Sentencia SQL para crear la tabla de Usuarios
        String sqlCreate ="CREATE TABLE IF NOT EXISTS biblioteca (id INTEGER PRIMARY KEY," +" titulo TEXT, autor TEXT, isbn INTEGER,editorial TEXT,numPag INTEGER,leido INTEGER)";
